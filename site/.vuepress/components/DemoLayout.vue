  ...
  if (pieDemo) {
    ...
    pieDemo.jsonObjects = [
      {
        ...
        about:
          "Lorem est nulla officia fugiat amet tempor dolor proident magna officia exercitation sit nostrud magna. Nulla voluptate amet labore dolor dolore pariatur nulla laboris proident nostrud pariatur deserunt est minim. Qui dolor pariatur commodo ad deserunt est qui. Excepteur nostrud deserunt ex labore adipisicing voluptate. Eu culpa anim sunt velit veniam dolor irure.\r\n",
      ...
      },
      {
        ...
        about:
          "Lorem qui cillum amet nostrud est laboris anim commodo. Occaecat pariatur et minim cupidatat ad eiusmod dolore cupidatat culpa. Adipisicing aute consequat dolor labore id aute duis esse id adipisicing dolore. Laborum labore cillum pariatur occaecat anim nisi Lorem.\r\n",
    ...
    if (pieDemo.loadPies) {
      if (!window["pie"]) {
        ...
        const packagesName = `@pie-element/${packages
          .slice(0, elementNumber)
          .join("+@pie-element/")}`.replace(/x-/g, "");
